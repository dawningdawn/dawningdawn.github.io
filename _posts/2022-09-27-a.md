...
* As our baby universe expands, it cools.
  ...
  <small>The standard model of particl physics is a theory that describes 3 of the 4 known fundamental forces (electromagnetic, weak, and strong forces) and classifies all known elementary particles.
  ...
  <small>A **fermion** is a particle that obeys the Fermi-Dirac statistics. F-D statistics is a type of quantum statistics that applies to the physics of a system comprised of many non-interacting, identical particles that obey the Pauli exclusion principle. A fermion has a half-odd-interger spin. ex. spin 1/2, 3/2, 5/2.
   <br>A **boson** is a particle that obeys the Bose-Einstein statistics. B-E statistics is a type of quantum statistics that applies to the physics of a system comprised of many non-interacting, indistinguishable particles, and describes how they may occupy a set of availabe discrete energy states at thermodynamic equilibrium. A boson has an integer spin. ex. spin 0, 1, 2.</small>
