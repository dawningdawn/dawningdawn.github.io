...
* As our baby universe expands, it cools.
  ...
  <br>[Image Source: Wikipedia--Standard Model](https://en.wikipedia.org/wiki/Standard_Model)
  <br>The standard model of particl physics is a theory that describes 3 of the 4 known fundamental forces (electromagnetic, weak, and strong forces) and classifies all known elementary particles.
