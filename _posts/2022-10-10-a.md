...
* In the beginning, there was _a primeval state_*, and spacetime** developed out of that state.
* Now we have the initial singularity*** -- a hot, dense state that contained all the energy and spacetime of the Universe. 
  ...
  <small>*Accodring to a qunatum theory of gravity, it could have been a virtual particle (a theoretical transient particle) or false vaccuum (a hypothetical vacuum that is stable, but not in the most stable state possible, and exists at a local minimum of energy). But who knows.</small>
